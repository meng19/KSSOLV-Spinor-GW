...
config_file = '/public/home/mxy/work/spinor_gw/speed/KSSOLV-Spinor-GW/si32.json';
profile_dir = fullfile(fileparts(config_file), 'si32_profile');
...
save(fullfile(profile_dir, 'si32_profile.mat'), 'profile_data');
