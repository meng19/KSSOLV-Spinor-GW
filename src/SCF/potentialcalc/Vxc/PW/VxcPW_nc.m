function [vxc,exc,rho] = VxcPW_nc(rho)
% VXCPW_NC PW exchange correlation for spin-noncollinear systems.
%    [vxc,exc,rho] = VXCPW_NC(rho) returns the PW exchange correlation of the
...
% PW functional for noncolinear spin 
