...
config_file = '/public/home/mxy/work/spinor_gw/speed/KSSOLV-Spinor-GW/si256.json';
profile_dir = fullfile(fileparts(config_file), 'si256_profile');
...
save(fullfile(profile_dir, 'si256_profile.mat'), 'profile_data');
