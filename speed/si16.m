...
config_file = '/public/home/mxy/work/spinor_gw/speed/KSSOLV-Spinor-GW/si16.json';
profile_dir = fullfile(fileparts(config_file), 'si16_profile');
...
save(fullfile(profile_dir, 'si16_profile.mat'), 'profile_data');
