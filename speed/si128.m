...
config_file = '/public/home/mxy/work/spinor_gw/speed/KSSOLV-Spinor-GW/si128.json';
profile_dir = fullfile(fileparts(config_file), 'si128_profile');
...
save(fullfile(profile_dir, 'si128_profile.mat'), 'profile_data');
