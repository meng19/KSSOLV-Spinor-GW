...
assert(direct_sig_relative_error < 1e-8, ...
    'AgBr spinor Cauchy COHSEX SMW sig validation failed: %.3e', ...
    direct_sig_relative_error);
assert(direct_eqp_relative_error < 1e-8, ...
    'AgBr spinor Cauchy COHSEX SMW eqp0 validation failed: %.3e', ...
    direct_eqp_relative_error);
