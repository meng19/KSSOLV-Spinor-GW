function [vxc,exc,rho,h2xc] = VxcPBE(mol,rho,grho2)
% VXCPBE PBE exchange correlation for spin-restricted systems.
%    [vxc,exc,rho,h2xc] = VXCPBE(mol,rho,grho2) returns the PBE exchange correlation
%    of the one-component rho for spin-restricted systems.
%
%   See also exRef.
...
exc(idxcxc) = exc(idxcxc) + e2*(egcx+egcc);
