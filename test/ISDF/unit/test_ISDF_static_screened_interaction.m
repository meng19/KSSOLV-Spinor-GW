...
screened = isdf_static_screened_interaction(vc_space, epsilon_vcoul, polar);
...
actual_matrix = isdf_screened_coulomb_kernel(screened, [], contract_vcoul);
...
actual_kernel = isdf_screened_coulomb_kernel(screened, target_zeta, contract_vcoul);
...
same_coul_actual = isdf_screened_coulomb_kernel(screened, target_zeta, epsilon_vcoul);
