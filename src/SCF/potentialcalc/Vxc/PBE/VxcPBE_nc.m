...
% VXCPBE_NC PBE exchange correlation for spin-noncollinear systems.
%    [vxc,exc,rho] = VXCPBE_NC(mol,rho) returns the PBE exchange correlation
%    of the four-component rho for spin-noncollinear systems.
%
%   See also exRef.
...
% GGA part
    ...
    [ex,ec,v1x,v2x,v1c,v2c,v2c_ud] = Vxc_gcxc(rhoaux,grho);
    vgxc = cell(2,1);
