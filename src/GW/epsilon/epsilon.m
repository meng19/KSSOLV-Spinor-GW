...
gw_section_banner('epsilon', 'start');
gw_timer('reset');
        ...
        for ik = 1:qdata.nrq
            ...
            if isempty(block.valence_bands) || isempty(block.conduction_bands)
                ...
                print_progress(current_epsilon_work, total_epsilon_work, ...
                    'Message', sprintf('E q%d k%d spin%d skipped (empty v-c space)', ...
                    iq, ik, ispin), ...
                    'Task', epsilon_task, ...
            ...
            current_epsilon_work = current_epsilon_work + ...
                epsilon_block_work;
            print_progress(current_epsilon_work, total_epsilon_work, ...
                'Message', sprintf('E q%d k%d spin%d block complete', ...
                iq, ik, ispin), ...
                'Task', epsilon_task, ...
                'PercentStep', progress_percent_step, ...
                'UpdateInterval', progress_update_interval);
