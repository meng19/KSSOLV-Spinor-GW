...
config_file = '/public/home/mxy/work/spinor_gw/speed/KSSOLV-Spinor-GW/si64.json';
profile_dir = fullfile(fileparts(config_file), 'si64_profile');
...
save(fullfile(profile_dir, 'si64_profile.mat'), 'profile_data');
