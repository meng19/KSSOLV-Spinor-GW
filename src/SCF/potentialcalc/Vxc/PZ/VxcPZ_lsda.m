function [vxc,exc,rho] = VxcPZ_lsda(rho)
% VXCPZ_LSDA PZ exchange correlation for spin-polarized systems.
%    [vxc,exc,rho] = VXCPZ_LSDA(rho) returns the PZ exchange correlation of the
