...
% GETEEWALD Compute the Ewald energy.
%    Eewald = getEewald(mol) get the Ewald energy by dividing
%    it to short-range and long-range parts and then calculate
%    them in real-space and G-space individually.
